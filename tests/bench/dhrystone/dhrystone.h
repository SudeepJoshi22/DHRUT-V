...
#elif defined(DHRUTV_RTLSIM)
                /* [DHRUT-V]: RTL-simulation timing path. Cycles come from */
                /* the mcycle CSR (see port.c), not a memory-mapped        */
                /* counter. HZ is an assumed clock used only to normalize  */
                /* the DMIPS score into DMIPS/MHz (frequency-independent), */
                /* not a real wall-clock rate. Too_Small_Time is set to 1  */
...
#define Start_Timer() Begin_Time = start_cycles
#define Stop_Timer() End_Time = start_cycles + elapsed_cycles

#elif defined(__riscv)

#define HZ CLOCKS_PER_SEC                        //[Mitu]: CPU speed in Hz on board
#define MHZ (HZ/1000000)                         //[Mitu]: CPU speed in MHz on board
#define Too_Small_Time (HZ/5)                    //[Mitu]: Run time = 200 ms
#define CLOCK_TYPE "CPU cycles counter"          //[Mitu]: Counter type
#define Start_Timer() Begin_Time = start_cycles  //[Mitu]: changed to stats var
#define Stop_Timer() End_Time = start_cycles + elapsed_cycles      //[Mitu]: changed to stats var
...
#define NUMBER_OF_RUNS		    ITERATIONS /* Default number of runs */
