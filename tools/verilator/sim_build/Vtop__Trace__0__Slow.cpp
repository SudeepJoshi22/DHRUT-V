...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+7,0,"redirect_pc",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->pushPrefix("imem", VerilatedTracePrefixType::SCOPE_INTERFACE);
    Vtop___024root__trace_init_sub__TOP__tb_top__DOT__imem_if__0(vlSelf, tracep);
    tracep->popPrefix();
    tracep->declBit(c+8,0,"if_valid",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+9,0,"if_pc",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+10,0,"if_instr",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__tb_top__DOT__imem_if__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+16,0,"ready",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+17,0,"addr",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
...
VL_ATTR_COLD void Vtop___024root__trace_full_0_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+5,(vlSelfRef.tb_top__DOT__dut__DOT__stall));
    bufp->fullBit(oldp+6,(vlSelfRef.tb_top__DOT__dut__DOT__flush));
    bufp->fullIData(oldp+7,(vlSelfRef.tb_top__DOT__dut__DOT__redirect_pc),32);
    bufp->fullBit(oldp+8,(vlSelfRef.tb_top__DOT__dut__DOT__if_valid));
    bufp->fullIData(oldp+9,(vlSelfRef.tb_top__DOT__dut__DOT__if_pc),32);
    bufp->fullIData(oldp+10,(vlSelfRef.tb_top__DOT__dut__DOT__if_instr),32);
    ...
    bufp->fullBit(oldp+15,(vlSymsp->TOP__tb_top__DOT__imem_if.valid));
    bufp->fullBit(oldp+16,(vlSymsp->TOP__tb_top__DOT__imem_if.ready));
    bufp->fullIData(oldp+17,(vlSymsp->TOP__tb_top__DOT__imem_if.addr),32);
    bufp->fullIData(oldp+18,(vlSymsp->TOP__tb_top__DOT__imem_if.wdata),32);
    bufp->fullCData(oldp+19,(vlSymsp->TOP__tb_top__DOT__imem_if.wstrb),4);
    bufp->fullIData(oldp+20,(vlSymsp->TOP__tb_top__DOT__imem_if.rdata),32);
}
