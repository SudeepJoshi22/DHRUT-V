    ...
    def runTests(self, testList):
	  ...
	  # echo statement.
          if self.target_run:
            ...
            # Added -l for log/trace and redirect to spike.log
            simcmd = self.dut_exe + ' -l --isa={0} +signature={1} +signature-granularity=4 {2} 2> spike.log'.format(self.isa, sig_file, elf)
          else:
            simcmd = 'echo "NO RUN"'
